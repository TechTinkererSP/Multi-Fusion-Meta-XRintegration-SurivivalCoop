...
namespace Fusion.Addons.ConnectionManagerAddon
{
    ...
    public class ConnectionManager2 : MonoBehaviour, INetworkRunnerCallbacks, Fusion.XR.Shared.IUserSpawner
#else
    public class ConnectionManager2 : MonoBehaviour, INetworkRunnerCallbacks
#endif
    {
        [System.Flags]
        ...
        private Transform GetNextSpawnPoint()
        {
            ...
            {
                Debug.LogError("No spawn points available. Ensure the spawnPoints list is populated in the Inspector.");
                return transform; // Fallback to the ConnectionManager2 position
            }

            Transform spawnPoint = spawnPoints[currentSpawnIndex];
            currentSpawnIndex = (currentSpawnIndex + 1) % spawnPoints.Count; // Cycle through the list
            return spawnPoint;
        }
        ...
        bool ShouldConnectWithRoomName => (connectionCriterias & ConnectionManager2.ConnectionCriterias.RoomName) != 0;
        bool ShouldConnectWithSessionProperties => (connectionCriterias & ConnectionManager2.ConnectionCriterias.SessionProperties) != 0;
        ...
        public async Task Connect()
        {
            ...
            if ((connectionCriterias & ConnectionManager2.ConnectionCriterias.RoomName) == 0)
            {
